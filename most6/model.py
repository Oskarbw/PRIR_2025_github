...
class Bridge:
    ...
    def random(cls, bridge_template):
        lower = constants.ELEMENT_DIAMETER_LOWER_BOUND
        upper = constants.ELEMENT_DIAMETER_UPPER_BOUND
        top_chord_diameter = random.uniform(lower, upper)
        bottom_chord_diameter = random.uniform(lower, upper)
        post_diameter = random.uniform(lower, upper)
        diagonal_diameter = random.uniform(lower, upper)
